package prosayj.framework.security.authentication;
...
import prosayj.framework.common.exception.user.CaptchaException;
import prosayj.framework.common.exception.user.CaptchaExpireException;
import prosayj.framework.common.exception.user.UserPasswordNotMatchException;
import prosayj.framework.common.utils.MessageUtils;
 ...
 */
@Component
public class SysUaaLoginService {
    @Autowired
